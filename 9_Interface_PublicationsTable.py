import os, json, unicodedata, yaml
...
scanTemplate = """
<button class="collapsible">Scan of the page</button>
<div class="content">
...
<tbody>
'<img src="@PAGEFILE@" width="100%" alt="">'
</tbody>
</table>
</div>
"""
...
def formatDistConnections(pathToMemex, distanceFile):
    ...
    distanceDict = json.load(open(distanceFile), encoding="utf8")
    ...
    with open(jsonFile, encoding="utf8") as jsonData:
        ...
        for o in range(0, len(orderedPages)):
            ...
            if k != "DETAILS":
                ...
                mainElement = scanTemplate.replace("@PAGEFILE@", "%s.png" % k)
                ...
                wordCloud = '\n<img src="../' + citeKey + '.png" width="100%" alt="wordcloud">'
